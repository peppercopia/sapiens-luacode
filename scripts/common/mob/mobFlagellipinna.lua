...
local mobFlagellipinna = {}

function mobFlagellipinna:load(mob, gameObject)
    mob:addType("flagellipinna", {
        
        deadObjectTypeIndex = gameObject.typeIndexMap.flagellipinnaDead,
        swims = true,
        disallowedBiomeTags = {
            "river",
        },
        ...
        addGameObjectInfo = {
            name = locale:get("mob_flagellipinna"),
            plural = locale:get("mob_flagellipinna_plural"),
            modelName = "flagellipinna",
            mobTypeIndex = mob.typeIndexMap.flagellipinna,
