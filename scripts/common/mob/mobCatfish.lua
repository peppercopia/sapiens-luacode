...
function mobCatfish:load(mob, gameObject)
    mob:addType("catfish", {
        
        deadObjectTypeIndex = gameObject.typeIndexMap.catfishDead,
        swims = true,
        ...
        addGameObjectInfo = {
            name = locale:get("mob_catfish"),
            plural = locale:get("mob_catfish_plural"),
            modelName = "catfish",
            mobTypeIndex = mob.typeIndexMap.catfish,
