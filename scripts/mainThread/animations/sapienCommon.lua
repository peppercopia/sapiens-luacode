...
local mainThreadParticleManagerInterface = mjrequire "mainThread/mainThreadParticleManagerInterface"
...
--[[function sapienCommon:addTalkingVariants(mainThreadAnimationGroup)
    for key,animation in pairs(mainThreadAnimationGroup.animations) do

    end
end]]

function sapienCommon:setup(mainThreadAnimationGroup, animationTypes, walkSpeedMultiplier)
    local walkDurationMultipier = 0.75 / walkSpeedMultiplier
    mainThreadAnimationGroup.animations = {
        ...
        [animationTypes.standCarry] = {
            keyframes = {
                {keyframes.stand_carry, 0.2},
           },
       },
        [animationTypes.pickup] = {
            keyframes = {
        ...
        [animationTypes.takeOffTorsoClothing] = {
            keyframes = {
                {keyframes.reachUp1, 0.2},
                {keyframes.reachUp2, 0.5, {randomVariance = 0.1}},
           },
       },
        [animationTypes.putOnTorsoClothing] = {
            keyframes = {
                {keyframes.reachUp1, 0.2},
                {keyframes.reachUp2, 0.5, {randomVariance = 0.1}},
           },
        ...
        [animationTypes.swimHighSmallCarry] = {
            keyframes = {
        ...
        [animationTypes.swimHighMediumCarry] = {
            keyframes = {
        ...
        [animationTypes.treadWaterSmallCarry] = {
            keyframes = {
        ...
        [animationTypes.throwAim] = {
            keyframes = {
                {keyframes.throwAim, 0.2},
           },
       },
        [animationTypes.throw] = {
            keyframes = {
        ...
        [animationTypes.highCarry] = {
            keyframes = {
                {keyframes.highCarry, 0.2},
           },
       },
        [animationTypes.pickupHighCarry] = {
            keyframes = {
                {keyframes.pickupHighCarry, 0.4},
           },
       },
        [animationTypes.addToHighCarry] = {
            keyframes = {
                {keyframes.addToHighCarry, 0.2},
           },
       },
        [animationTypes.placeCrouchHighCarry] = {
            keyframes = {
                {keyframes.addToHighCarry, 0.4},
           },
       },
        [animationTypes.removeFromHighCarry] = {
            keyframes = {
                {keyframes.pickupHighCarry, 0.2},
           },
       },
        [animationTypes.highSmallCarry] = {
            keyframes = {
                {keyframes.highSmallCarry, 0.2},
           },
       },
        [animationTypes.pickupHighSmallCarry] = {
            keyframes = {
                {keyframes.pickupHighSmallCarry, 0.4},
           },
       },
        [animationTypes.addToHighSmallCarry] = {
            keyframes = {
                {keyframes.addToHighSmallCarry, 0.2},
           },
       },
        [animationTypes.placeCrouchHighSmallCarry] = {
            keyframes = {
                {keyframes.addToHighSmallCarry, 0.4},
           },
       },
        [animationTypes.removeFromHighSmallCarry] = {
            keyframes = {
                {keyframes.pickupHighSmallCarry, 0.2},
           },
       },
        [animationTypes.highMediumCarry] = {
            keyframes = {
                {keyframes.highMediumCarry, 0.2},
           },
       },
        [animationTypes.pickupHighMediumCarry] = {
            keyframes = {
                {keyframes.pickupHighMediumCarry, 0.4},
           },
       },
        [animationTypes.addToHighMediumCarry] = {
            keyframes = {
                {keyframes.addToHighMediumCarry, 0.2},
           },
       },
        [animationTypes.placeCrouchHighMediumCarry] = {
            keyframes = {
                {keyframes.addToHighMediumCarry, 0.4},
           },
       },
        [animationTypes.removeFromHighMediumCarry] = {
            keyframes = {
                {keyframes.pickupHighMediumCarry, 0.2},
           },
       },
        [animationTypes.smallCarry] = {
            keyframes = {
                {keyframes.smallCarry, 0.2},
           },
       },
        [animationTypes.pickupSmallCarry] = {
            keyframes = {
                {keyframes.pickupSmallCarry, 0.4},
           },
       },
        [animationTypes.addToSmallCarry] = {
            keyframes = {
                {keyframes.addToSmallCarry, 0.2},
           },
       },
        [animationTypes.placeCrouchSmallCarry] = {
            keyframes = {
                {keyframes.addToSmallCarry, 0.4},
           },
       },
        [animationTypes.removeFromSmallCarry] = {
            keyframes = {
                {keyframes.pickupSmallCarry, 0.2},
           },
       },
        [animationTypes.crouchSmallCarrySingle] = {
            keyframes = {
                {keyframes.crouchSmallCarry, 0.2},
           },
       },
        [animationTypes.crouchSmallCarryMulti] = {
            keyframes = {
                {keyframes.addToSmallCarry, 0.2},
           },
       },
        [animationTypes.crouchHighCarry] = {
            keyframes = {
                {keyframes.addToHighCarry, 0.2},
           },
       },
        [animationTypes.crouchHighSmallCarry] = {
            keyframes = {
                {keyframes.addToHighSmallCarry, 0.2},
           },
       },
        [animationTypes.crouchHighMediumCarry] = {
            keyframes = {
                {keyframes.addToHighMediumCarry, 0.2},
           },
       },
        [animationTypes.crouchSingleCarry] = {
            keyframes = {
    ...
    local function addWalkRunCycle(baseName, keyframeBaseName, frameDuration, stepTriggerToUse, durationMultipliersOrNil, additionalCompositeOrNil)
        ...
        mainThreadAnimationGroup.animations[animationTypes[baseName]] = {
            keyframes = {
        ...
        mainThreadAnimationGroup.animations[animationTypes[baseName .. "Carry"]] = {
            keyframes = {
        ...
        mainThreadAnimationGroup.animations[animationTypes[baseName .. "HighCarry"]] = {
            keyframes = {
        ...
        mainThreadAnimationGroup.animations[animationTypes[baseName .. "HighSmallCarry"]] = {
            keyframes = {
        ...
        mainThreadAnimationGroup.animations[animationTypes[baseName .. "HighMediumCarry"]] = {
            keyframes = {
        ...
        mainThreadAnimationGroup.animations[animationTypes[baseName .. "SmallCarry"]] = {
            keyframes = {
        ...
        mainThreadAnimationGroup.animations[animationTypes[baseName .. "Wave"]] = {
            keyframes = {
    ...
    --mj:log(mainThreadAnimationGroup.animations[animationTypes["sneakHighCarry"]])


    mainThreadAnimationGroup.limits = {--Designed exclusively for head movement, if limits are set like this, currently roll is not supported, any z rotation will be discarded, with optionally a random roll generated and added.
        {
            boneName = "head",
            pitch = {
                min = -0.7, --up
    ...
    mainThreadAnimationGroup.default = animationTypes.stand
