...
void main()
{
    ...
    float size = particleSize * typeAndLifeLeftAndRandomValueAndScale.w * 0.4;
    vec2 vertPos = vec2(-0.5 + texCoord.x, (-0.5 + texCoord.y) * 200.0);
    float rotation = (typeAndLifeLeftAndRandomValueAndScale.z - 0.5) * 0.2;
