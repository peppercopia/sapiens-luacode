...
layout(location = 2) out vec2 lifeColorOffset;
layout(location = 3) out vec3 outWorldPos;
layout(location = 4) out vec3 outSunPos;
layout(location = 5) out vec4 outLightAddition_cloudCover;
layout(location = 6) out vec4 outShadowCoords[4];
layout(location = 10) out vec4 outRainDepthCoords;
...
void main()
{
    ...
    float rotation = typeAndLifeLeftAndRandomValueAndScale.z * M_2PI + typeAndLifeLeftAndRandomValueAndScale.w * 32.0 * (typeAndLifeLeftAndRandomValueAndScale.z - 0.5);
    ...
    lifeColorOffset = vec2(texOffset.x + 0.125 * (1.0 - typeAndLifeLeftAndRandomValueAndScale.y), texOffset.y + 0.00390625 - 0.0009765625);
