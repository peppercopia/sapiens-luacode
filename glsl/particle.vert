...
void main()
{
    ...
    float yOffset = (posOffset - posOffsetFract) * 0.125 + 0.0078125;

    texOffset = vec2(posOffsetFract,1.0 - yOffset);
    outTexCoord = texCoord;

    lifeColorOffset = vec2(texOffset.x + 0.125 * (1.0 - min(typeAndLifeLeftAndRandomValueAndScale.y, 1.0)), texOffset.y + 0.0078125 - 0.0009765625);
