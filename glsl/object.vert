...
void main(void)
{
    ...
    //outView = (ubo.mv_matrix * camera.camOffsetPosWorld).xyz - ubo.translation.xyz - rotatedPosition;
    outView = (camera.camOffsetPosWorld.xyz + ubo.camPos.xyz) - ubo.translation.xyz - rotatedPosition;
