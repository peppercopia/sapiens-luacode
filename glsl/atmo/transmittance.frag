...
void main() {
    ...
    vec3 depth = ubo.betaRAndHR.xyz * opticalDepth(ubo.betaRAndHR.w, r, muS) + ubo.betaMExAndmieG.xyz * opticalDepth(ubo.betaMScaAndHM.w, r, muS);
    data = vec4(exp(-depth), 1.0); // Eq (5)
}