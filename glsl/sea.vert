...
layout(location = 14) out mat4 outReflectionProjView;
...
outCamPos = (camera.camOffsetPosWorld.xyz + ubo.camPos.xyz);
    ...
    outReflectionProjView = camera.proj * camera.worldView;
    ...
    vec3 offsetPos = pos.xyz + normalize(pos.xyz + ubo.originWindStrength.xyz) * waveHeight;
    ...
    outWorldPos = (pos.xyz + ubo.originWindStrength.xyz) * 8.388608;
    ...
    outNormal = normalize(pos.xyz + ubo.originWindStrength.xyz);
    
    outWorldCamPos = (ubo.camPos.xyz + ubo.originWindStrength.xyz) * 8.388608;
